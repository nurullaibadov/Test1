        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundCheckUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    MedicalCertificateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuxInput = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedsDriver = table.Column<bool>(type: "bit", nullable: false),
                    WithInsurance = table.Column<bool>(type: "bit", nullable: false),
                    WithGPS = table.Column<bool>(type: "bit", nullable: false),
                    WithChildSeat = table.Column<bool>(type: "bit", nullable: false),
                    AdditionalDrivers = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarTrackings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarTrackings_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrls = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsVerifiedRental = table.Column<bool>(type: "bit", nullable: false),
                    IsApproved = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarTrackings_BookingId",
                table: "CarTrackings",
                column: "BookingId");
